...
//! the watch compares that replay with its own notifications and marks the ones iOS no longer has
//! as dismissed, like a removal it had seen live (see ancs_reconcile.h).
//!
