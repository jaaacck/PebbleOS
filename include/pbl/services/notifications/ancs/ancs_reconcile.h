...
//! UIDs are unchanged: removes the active iOS notifications whose UID iOS no longer has.
...
//! UIDs changed: matches notifications on app and timestamp, removes the ones iOS no longer has
